# Terrafrom 
# Optional configuration for terraform engine
terraform {
    required_version = ">=0.12.0"
}

# Provider
# Implements cloud specific API and Terraform API.
...
variable "bucket_name" {
    ...
    # then a value must be supplied.:w
...
locals {
    ...
    lt = 1 < 2 // true if left value is less
    lte = 1 <=2 //true if left value is less or equal
...
# full desciptive paragraphs too.
